...
public class Find_Suddent_Impact extends Base{
	
	public Find_Suddent_Impact() {
	...
	//Find Sudden Impact
			@FindBy(xpath="//div[@id='General']//div[@class='GenericMenuGroup--content--item col-12 col-lg-6 col-xl-4']/..//span[contains(text(),'Find Sudden Impact (Legacy Search)')]")
			WebElement findSuddenImpact;
			//Part Number 
			...
			public void validateFindSuddentImpact() {
				
				findSuddenImpact.click();
