...
public class Find_Features extends Base{

	
	public Find_Features() {
	...
	//Find Features
	@FindBy(xpath="//div[@id='General']//div[@class='GenericMenuGroup--content--item col-12 col-lg-6 col-xl-4']/..//span[contains(text(),'Find Features (Legacy Search)')]")
	WebElement findFeatures;
	//Part Number 
	...
	public void validateFindFeatures() {
